...
imagePoints = path + "Images\\" + "pointsOnImage" + ".jpg" #br
...
def imagePTS():
    ...
    for p in preds:
        for i in p:
            ...
            cv2.circle(imageCV,(i[0], i[1]), 3, (0,255,0), -1) #br
    ...
    cv2.imwrite(imagePoints, imageCV) #br
    gImage = Image.open(image) #br
    gImage1 = Image.open(imagePoints) #br

    imageList = [gImage,gImage1] #br

    imageList[0].save('pointsOnFace.gif',save_all=True, append_images=imageList[1:], duration=200, loop=0) #br
